...
commander_1.program
    ...
    .action(function (artist, song) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, e_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                _b = (_a = console).log;
                return [4 /*yield*/, index_1.default(artist, song)];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [3 /*break*/, 3];
            case 2:
...
commander_1.program.parseAsync().catch(function (e) {
